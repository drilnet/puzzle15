...
Иллюстрация взята с [https://en.wikipedia.org/wiki/15_puzzle](https://en.wikipedia.org/wiki/15_puzzle "Нажмите")
<br>
<span title="Спасибо за иллюстрацию!">Thank you very much!</span>

**Уважаемый соискатель!**
<br>
Эта возможность (**15**, **14**) есть в игре!
<br>
Можете попробовать! :)
...
**Примечание.**
<br>
Ссылки на **Вики** написаны в алфавитном порядке!
